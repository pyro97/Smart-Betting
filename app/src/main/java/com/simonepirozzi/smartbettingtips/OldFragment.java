...
public class OldFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        final View view=inflater.inflate(R.layout.fragment_old, container, false);
    ...
    public void pronostici(){
        db.collection("/pronostici").whereEqualTo("pagina","vecchia").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
